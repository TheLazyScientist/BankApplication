namespace Bankkonto
{
    internal static class Messages
    {
        ...
        public static string[] budgettingMessage = { "1: Create a new Guide  2: Reset to Guide", "3: Hushålla din ekonomi  4: Check your budgeting history", "5: Return to Main menu" };
